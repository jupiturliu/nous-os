...
class BenchmarkTests(unittest.TestCase):
    ...
    def test_student_sandbox_v1_web_renders_phases_checklist_and_reflection(self) -> None:
        ...
        self.assertIn("First-trial run checklist", html)
        self.assertIn("student-adjacent participant", html)
        self.assertIn("Obsidian 04 Reviews", html)
        self.assertIn("Choose exactly one next-run change", html)
    ...
    def test_student_session_review_page_reads_local_backend_record(self) -> None:
        ...
        self.assertIn("Copy packet", html)
        self.assertIn("Download .md", html)
        self.assertIn("exportPacket", html)
        self.assertIn("copyPacket", html)
        self.assertIn("downloadPacket", html)
        self.assertIn("navigator.clipboard.writeText", html)
...
class SiteContractTests(unittest.TestCase):
    ...
    def test_research_pipeline_cockpit_runs_northstar_workflow(self) -> None:
        ...
        for required in (
            ...
            "What kind of moment are you studying?",
            "Help a student think better",
            "Review a real decision",
            "Improve memory and reflection",
            "The friendly choice above is stored as the research sub-line metadata",
            "L1 · Learning loop",
            "L2 · Decision loop",
            "L3 · Knowledge loop",
            "docs/research-line/session-review-index.md",
            ...
            "Scenario updated. Generate a fresh Markdown packet when ready.",
